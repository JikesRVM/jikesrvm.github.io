...
\begin{itemize}
  ...
  \item \hyperref[cha:classlibraryinterface]{Interface to the Class Library}: This component is responsible for handling the interaction between the Core Runtime Services and the Java class library.
\end{itemize}
